...
<head>
	...
	<!-- css files -->
	<link href="/car/css/bootstrap.min.css" rel="stylesheet" type="text/css" media="all" />
	<link href="/car/css/font-awesome.min.css" rel="stylesheet" type="text/css" media="all" />
	<link href="/car/css/style.css" rel="stylesheet" type="text/css" media="all"/>
	<!-- /css files -->
	<!-- font files -->
	...
	<!-- /font files -->
	<!-- js files -->
	<script src="/car/js/modernizr.custom.js"></script>
	<!-- /js files -->
</head>
		...
		<nav class="navbar navbar-inverse navbar-static-top cl-effect-20">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.ftl">Outing</a>
				</div>
				<div id="navbar" class="navbar-collapse collapse navbar-right">
					<ul class="nav navbar-nav">
						<li><a href="#"><span data-hover="首页">首页</span></a></li>
						<li><a href="#about"><span data-hover="品牌中心">品牌中心</span></a></li>
						<li><a href="#service"><span data-hover="汽车隔热膜">汽车隔热膜</span></a></li>
						<li><a href="#events"><span data-hover="漆面保护膜">漆面保护膜</span></a></li>
						<li><a href="#gallery"><span data-hover="新闻中心">新闻中心</span></a></li>
						<li><a href="#testimonials"><span data-hover="质保查询">质保查询</span></a></li>
						<li><a href="#contact"><span data-hover="合作加盟">合作加盟</span></a></li>
						<li><a href="#contact"><span data-hover="客户服务">客户服务</span></a></li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
	...
	<div class="carousel-inner" role="listbox">
		<div class="item active">
			<img class="first-slide" src="/car/images/banner1.jpg" alt="First slide"/>
		</div>
		<div class="item">
			<img class="second-slide" src="/car/images/banner2.jpg" alt="Second slide"/>
		</div>
		<div class="item">
			<img class="third-slide" src="/car/images/banner3.jpg" alt="Third slide"/>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-6">
				<img src="/car/images/about-img.jpg" alt="about" class="img-responsive slideanim"/>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6">
	...
	<div id="features">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<img src="/car/images/service-img.jpg" class="img-responsive slideanim" alt="service"/>
				</div>
			</div>
		</div><!--/ .container -->
	</div><!--/ #features -->
...
<section class="our-gallery" id="gallery">
	...
	<p class="text-center slideanim">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
	<div class="container">
		<img src="/car/images/gallery-img1.jpg" data-darkbox="/car/images/gallery-img1-1.jpg" data-darkbox-description="<b>Lorem Ipsum</b><br>Lorem ipsum dolor sit amet" class="img-responsive slideanim" />
		<img src="/car/images/gallery-img2.jpg" data-darkbox="/car/images/gallery-img2-2.jpg" data-darkbox-description="<b>Lorem Ipsum</b><br>Lorem ipsum dolor sit amet" class="img-responsive slideanim" />
		<img src="/car/images/gallery-img3.jpg" data-darkbox="/car/images/gallery-img3-3.jpg" data-darkbox-description="<b>Lorem Ipsum</b><br>Lorem ipsum dolor sit amet" class="img-responsive slideanim" />
		<img src="/car/images/gallery-img4.jpg" data-darkbox="/car/images/gallery-img4-4.jpg" data-darkbox-description="<b>Lorem Ipsum</b><br>Lorem ipsum dolor sit amet" class="img-responsive slideanim" />
		<img src="/car/images/gallery-img5.jpg" data-darkbox="/car/images/gallery-img5-5.jpg" data-darkbox-description="<b>Lorem Ipsum</b><br>Lorem ipsum dolor sit amet" class="img-responsive slideanim" />
		<img src="/car/images/gallery-img6.jpg" data-darkbox="/car/images/gallery-img6-6.jpg" data-darkbox-description="<b>Lorem Ipsum</b><br>Lorem ipsum dolor sit amet" class="img-responsive slideanim" />
		<img src="/car/images/gallery-img7.jpg" data-darkbox="/car/images/gallery-img7-7.jpg" data-darkbox-description="<b>Lorem Ipsum</b><br>Lorem ipsum dolor sit amet" class="img-responsive slideanim" />
		<img src="/car/images/gallery-img8.jpg" data-darkbox="/car/images/gallery-img8-8.jpg" data-darkbox-description="<b>Lorem Ipsum</b><br>Lorem ipsum dolor sit amet" class="img-responsive slideanim" />
	</div>
</section>
<!-- /Gallery Section -->
<!-- Testimonials -->
<section class="our-testimonials slideanim" id="testimonials">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-4 col-md-4">
				<div class="test">
					<img src="/car/images/test-img1.png" class="img-responsive slideanim" alt=""/>
			...
			<div class="col-lg-4 col-md-4">
				<div class="test">
					<img src="/car/images/test-img2.png" class="img-responsive slideanim" alt=""/>
					<h4 class="text-center slideanim">Lorem Ipsum</h4>
					<p class="t1 slideanim">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-4">
				<div class="test">
					<img src="/car/images/test-img3.png" class="img-responsive slideanim" alt=""/>
					<h4 class="text-center slideanim">Lorem Ipsum</h4>
					<p class="t1 slideanim">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
				</div>
			</div>
...
<!-- js files -->
<script src="/car/js/jquery.min.js"></script>
<script src="/car/js/bootstrap.min.js"></script>
<script src="/car/js/SmoothScroll.min.js"></script>
<!-- js for gallery -->
<script src="/car/js/darkbox.js"></script>
<!-- /js for gallery -->
<!-- js for back to top -->
